...
def load_jobs(driver, country):
    ...
    while(flag):
        try:
            ...
            scraped_data = scrap_jobs(driver,country)
...
def start_script():
    try:
        urls = ["https://www.knx.org/knx-en/for-professionals/community/partners/index.php?country=170",
